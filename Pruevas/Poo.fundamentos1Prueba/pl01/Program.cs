...
namespace pl01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            UtilidadFecha utilidadFecha01 = new UtilidadFecha();
            int edad = utilidadFecha01.CalcularEdad(date);
            ...
            UtilidadFecha utilidadFecha02 = new UtilidadFecha();
            ...
            
            {
                ...
                Edad = utilidadFecha02.CalcularEdad(new DateTime(1995, 11, 07))
            };
